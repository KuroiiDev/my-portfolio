...
window.openProjectModal = function (project) {
    ...
    if (!project.github_url && !project.live_url) {
        actionsEl.innerHTML = `<span class="modal-no-links">// no public links available</span>`;
    } else {
        if (project.github_url) {
            actionsEl.innerHTML += `
                <a href="${project.github_url}" target="_blank" class="modal-btn modal-btn-github">
        ...
        if (project.live_url) {
            actionsEl.innerHTML += `
                <a href="${project.live_url}" target="_blank" class="modal-btn modal-btn-live">

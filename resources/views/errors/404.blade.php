        ...
        <div class="uc-wrapper">
            ...
            <div class="uc-card">
                ...
                <div class="terminal-bar">
                    ...
                    <span class="terminal-title">~/system/404-page-not-found.sh</span>
                ...
                <div class="uc-body">
                    ...
                    <div class="uc-output mt-3">
                        <p>
                            ...
                            <span class="t-lilac">{{ $title ?? 'This page' }}</span>
                            <span class="t-muted"> can't be found.</span>
                        </p>
                        <p class="mt-1">
                            <span class="t-muted">// Expected to not be available.</span>
                        </p>
                    </div>
                    ...
                    <div class="uc-output mt-3">
                        <p>
                            ...
                            <span class="t-muted"> is looking for it</span>
                            <span class="t-dots"></span>
                        </p>
                        <p class="mt-1">
                            <span class="t-muted">// make sure you typed the URL correctly</span>
                        </p>
                    </div>
                    ...
                    <div class="uc-output mt-3">
                        <div class="uc-progress-label">
                            <span class="t-muted">searching</span>
